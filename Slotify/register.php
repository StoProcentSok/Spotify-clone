    ...
    <div id="background">
        <div id="loginContainer">
            ...
            <div id="inputContainer">
                <form id="loginForm" action="register.php" method="POST">
                    ...
                    <p>
                        ...
                        <input id="loginUsername" name="loginUsername" type="text" placeholder="e.g. Michal Buczek" value="<?php getInputValue('loginUsername') ?>" required>   
                    </p>
                    <p>
            ...
            <div id="loginText">
                ...
                <h2>Listen to loads of songs right now<h2>
                <ul>
